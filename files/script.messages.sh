...
ubuntuCmd2="apt-get -y install git-core maven2 >> ${statusFile} 2>&1"
ubuntuCmd3="apt-get -y install openjdk-6-jdk default-jre >> ${statusFile} 2>&1"
...
redhatCmd2="yum -y install git-core >> ${statusFile} 2>&1"
redhatCmd3="yum -y install java-1.7.0-openjdk java-1.7.0-openjdk-devel >> ${statusFile} 2>&1"
...
centosCmd2="yum -y install git >> ${statusFile} 2>&1"
centosCmd3="yum -y install java-1.7.0-openjdk java-1.7.0-openjdk-devel >> ${statusFile} 2>&1"
